package com.sini.myselectshop.aop;
...
public class UseTimeAop {
    ...
    @Pointcut("execution(* com.sini.myselectshop.controller.ProductController.*(..))")
    private void product() {}
    @Pointcut("execution(* com.sini.myselectshop.controller.FolderController.*(..))")
    private void folder() {}
    @Pointcut("execution(* com.sini.myselectshop.naver.controller.NaverApiController.*(..))")
    private void naver() {}
